...
int main()
{
	const auto houseBase = std::make_shared<Circle>(Frame{{100, 300}, 400, 300}, 0x8B4513, 0x000000);
	...
	const auto door = std::make_shared<Circle>(Frame{{250, 450}, 100, 150}, 0xD2691E, 0x000000);

	GroupShape houseGroup({ houseBase, houseRoof, window1, window2, door });

	const auto treeTrunk = std::make_shared<Circle>(Frame{{600, 400}, 40, 100}, 0x8B4513, 0x000000);
